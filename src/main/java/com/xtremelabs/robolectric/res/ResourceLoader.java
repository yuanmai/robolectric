...
public class ResourceLoader {
    ...
    private void init() {
        ...
        try {
            if (resourceDir != null) {
                ...
                loadPreferenceResources(resourceDir);
            } else {
                viewLoader = null;
                menuLoader = null;
            }
    ...
    private void loadPreferenceResources(File xmlResourceDir) throws Exception {
        ...
        loadPreferenceResourceXmlSubDirs(preferenceDocumentLoader, xmlResourceDir);
    }
    ...
    private void loadPreferenceResourceXmlSubDirs(DocumentLoader preferenceDocumentLoader, File xmlResourceDir) throws Exception {
        if (xmlResourceDir != null) {
            preferenceDocumentLoader.loadResourceXmlDirs(xmlResourceDir.listFiles(XML_DIR_FILE_FILTER));
        }
    }

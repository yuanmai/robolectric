...
public class BitmapFactoryTest {
    ...
    public void decodeResource_shouldSetDescription() throws Exception {
        ...
        assertEquals("Bitmap for resource: drawable/an_image", shadowOf(bitmap).getOriginalDescription());
    ...
    public void decodeFile_shouldSetDescription() throws Exception {
        ...
        assertEquals("Bitmap for file: /some/file.jpg", shadowOf(bitmap).getOriginalDescription());
        assertEquals(100, bitmap.getWidth());
        assertEquals(100, bitmap.getHeight());
    }
    ...
    public void decodeStream_shouldSetDescription() throws Exception {
        ...
        assertEquals("Bitmap for content:/path", shadowOf(bitmap).getOriginalDescription());
        assertEquals(100, bitmap.getWidth());
        assertEquals(100, bitmap.getHeight());
    }
